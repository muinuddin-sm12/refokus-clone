...
const Navbar = () => {
  return (
    <div className="max-w-screen-xl bg-zinc-900 text-white flex justify-between items-center mx-auto py-6 border-b-[1px] border-zinc-700">
      <div className="flex items-center">
        ...
        <div className="links flex items-center gap-14 ml-20">
          {["Home", "Work", "Culture", "", "News"].map((elem, index) =>
            elem.length === 0 ? (
              <span key={elem} className="h-5 w-[1px] bg-zinc-700"></span>
            ) : (
              <a
              ...
              >
                {index === 1 && (
                  <span
                    ...
                    className="inline-block h-[5px] w-[5px] rounded-full bg-green-400"
                  ></span>
                )}
                {elem}
              </a>
